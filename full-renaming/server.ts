...
import {makeTask,applyCandidatesList, Task,Candidates, sListTocList} from "./renamer.js";
...
const createServerResponse=(task:Task,candidates:Candidates[]):APIResponse=>{
	const renames=candidates.map(({
		variable,
		names
	})=>({
		id:`_${nanoid()}_`,
